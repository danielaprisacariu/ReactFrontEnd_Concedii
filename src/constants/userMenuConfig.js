...
import CerereConcediu from '../features/CerereConcediu/CererereConcediuContainer'
...
const userMenuItems = [
  ...
  { icon: <CalendarToday />, text: 'Cerere Concediu', path: '/CerereConcediu', name: 'Cerere Concediu' }
]
