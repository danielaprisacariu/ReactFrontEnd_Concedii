...
import CerereConcediu from 'components/CerereConcediu/CerereConcediuContainer'
...
const userMenuItems = [
  ...
  { icon: <cerereConcediu />, text: 'Cerere Concediu', path: '/CerereConcediuContainer', name: 'CerereConcediu' }
]
